...
$(function(){svg4everybody(),$(".js-open-popup-link").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom",closeMarkup:'<button title="%title%" type="button" class="mfp-close cmn-popup__close-btn">×</button>'}),$(".js-test-slider").slick({slidesToShow:3,autoplay:!0,autoplaySpeed:3e3,arrows:!0,dots:!1,appendArrows:$(".js-otdelka-slider-nav"),nextArrow:'<button type="button" class="slick-next"><svg class="icon-svg icon-13"><use xlink:href="images/sprite.svg#13"></use></svg></button>',prevArrow:'<button type="button" class="slick-prev"><svg class="icon-svg icon-14"><use xlink:href="images/sprite.svg#14"></use></svg></button>',responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:575,settings:{slidesToShow:1}}]}),$(".js-totop-btn").on("click",function(s){s.preventDefault(),$("html, body").animate({scrollTop:0},"500")}),$(".js-hamburger").click(function(){$(".mobileMenu").toggleClass("active")}),$(".form__popup").submit(function(){var s=$(this);return afterTxt=$(s).find(".success"),$.ajax({type:"POST",url:"mail.php",data:s.serialize()}).done(function(){$(afterTxt).addClass("form__success_visible"),setTimeout(function(){s.trigger("reset"),$(afterTxt).removeClass("form__success_visible"),$.magnificPopup.close()},3e3)}),!1})});