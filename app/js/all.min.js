...
$(function(){var t=$("body").data("sprite");svg4everybody(),$(".js-open-popup-link").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:500,mainClass:"my-mfp-slide-bottom",closeMarkup:'<button title="Закрыть (ESC)" type="button" class="mfp-close popup__close-btn">×</button>',callbacks:{beforeOpen:function(){this.st.mainClass="mfp-zoom-out"}}}),$(".js-slider").slick({slidesToShow:3,autoplay:!0,autoplaySpeed:3e3,arrows:!0,dots:!1,prevArrow:'<button type="button" class="btn-slick slick-prev"><svg class="icon-svg icon-14"><use xlink:href="'+t+'#14"></use></svg></button>',nextArrow:'<button type="button" class="btn-slick slick-next"><svg class="icon-svg icon-13"><use xlink:href="'+t+'#13"></use></svg></button>',responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:575,settings:{slidesToShow:1}}]}),$(".js-to-top-btn").on("click",function(t){t.preventDefault(),$("html, body").animate({scrollTop:0},"500")}),$(document).on("click","a.js-anchor-link",function(t){t.preventDefault(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top},700)})});