...
$(function(){svg4everybody(),$(".js-open-popup-link").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom",closeMarkup:'<button title="%title%" type="button" class="mfp-close"></button>'}),$(".js-totop-btn").on("click",function(e){e.preventDefault(),$("html, body").animate({scrollTop:0},"500")}),$(".js-hamburger").click(function(){$(".mobileMenu").toggleClass("active")}),$(".form__popup").submit(function(){var e=$(this);return afterTxt=$(e).find(".success"),$.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(afterTxt).addClass("form__success_visible"),setTimeout(function(){e.trigger("reset"),$(afterTxt).removeClass("form__success_visible"),$.magnificPopup.close()},3e3)}),!1})}),$(window).load(function(){$(".loader-inner").fadeOut(),$(".loader").delay(400).fadeOut("slow")});